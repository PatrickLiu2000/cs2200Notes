...
![](./images/ch9/15.PNG)
![](./images/ch9/4.PNG)
**SPECIAL CASE FOR SET ASSOCIATIVE CACHE**
![](./images/ch9/14.PNG)
  - p = degree of associativity
  - a = number of bits in memory address
  - L = number of lines in a direct mapped cache
  - S = cache size
  - B = number of bytes per block
  - b = LSB of memory address = block offset
  - t = MSB of memory address = cache tag
  - n = middle bits = cache index
